...
import {
  ...
  Menu, LogOut, Clock, CheckSquare, Truck, Contact, Trophy, ShieldCheck, ShoppingBag, ClipboardList, Bell, ShieldAlert
} from 'lucide-react';
...
export const App: React.FC = () => {
  const { notifications, isAuthenticated, currentUser, logout, tasks } = useData();
