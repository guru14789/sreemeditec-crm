...
export const LogsModule: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col gap-3 md:gap-6 relative p-1 md:p-2">
            ...
            <div className="bg-white rounded-[2rem] md:rounded-3xl shadow-sm border border-slate-300 flex flex-col overflow-hidden flex-1">
                {/* Search & Filter Bar */}
                <div className="p-3 md:p-5 border-b border-slate-300 flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4 bg-slate-50/20">
                    <div className="flex items-center gap-3">
                        <div className="p-2 md:p-2.5 bg-medical-50 text-medical-600 rounded-[2rem] md:rounded-[2rem] shadow-sm">
                            <Activity size={18} />
                        </div>
                        <div>
                    ...
                    <div className="flex flex-wrap gap-2 md:gap-3">
                        <div className="relative group flex-1 md:flex-none">
                            ...
                            <input 
                                ...
                                className="pl-9 pr-4 py-2 md:py-2.5 bg-white border border-slate-300 rounded-lg md:rounded-[2rem] text-xs font-bold focus:outline-none focus:border-medical-500 transition-all w-full md:w-64"
                                value={searchQuery}
                        ...
                        <div className="flex gap-2 w-full sm:w-auto">
                            <button 
                                ...
                                disabled={isLoading}
                                className={`flex-1 md:flex-none p-2 bg-white border border-slate-300 rounded-lg md:rounded-[2rem] text-slate-600 hover:text-medical-600 hover:border-medical-300 transition-all ${isLoading ? 'animate-spin text-medical-600' : ''}`}
                            >
                                <Activity size={16} />
                            </button>
                            ...
                            <button 
                                ...
                                className="flex-1 md:flex-none px-3 py-2 bg-medical-50 text-medical-700 border border-medical-100 rounded-lg md:rounded-[2rem] text-[9px] font-black uppercase tracking-widest hover:bg-medical-100 transition-all flex items-center justify-center gap-2"
                            >
                                ...
                                <tr key={log.id} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="px-3 md:px-6 py-2 md:py-4">
                                        <div className="flex gap-2 md:gap-3">
                                            <div className="flex flex-col items-center shrink-0">
                                                <div className="text-[9px] font-black text-slate-800 leading-none mb-0.5 md:mb-1">{formatTime(log.timestamp).slice(0, 5)}</div>
                                            ...
                                            <div className="min-w-0">
                                                <div className="text-[9px] font-black text-slate-700 leading-none mb-0.5 md:mb-1 truncate max-w-[80px] md:max-w-none">{log.userName}</div>
                                    ...
                                    <td className="px-3 md:px-6 py-2 md:py-4">
                                        <div className="max-w-md">
                                            <p className="text-[9px] font-bold text-slate-700 leading-tight md:leading-relaxed italic border-l md:border-l-2 border-slate-100 pl-2 md:pl-3 line-clamp-2 md:line-clamp-none">
                    ...
                    {hasMoreLogs && (
                        <div className="p-4 md:p-6 flex justify-center border-t border-slate-100 bg-slate-50/30">
                            <button 
                                ...
                                disabled={isLoading}
                                className="px-6 md:px-8 py-2.5 md:py-3 bg-white border border-slate-200 text-medical-600 rounded-[2rem] md:rounded-[2rem] text-[10px] md:text-xs font-black uppercase tracking-widest shadow-sm hover:shadow-md hover:border-medical-200 transition-all flex items-center gap-2 md:gap-3 disabled:opacity-50"
                            >
