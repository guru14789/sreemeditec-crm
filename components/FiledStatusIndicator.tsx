...
export const FiledStatusIndicator: React.FC<FiledStatusIndicatorProps> = ({
  ...
  if (filedStatus === 'Filed') {
    return (
      <button
        ...
        className="inline-flex items-center justify-center w-7 h-7 rounded-xl border border-emerald-200 bg-emerald-50 hover:bg-emerald-100 hover:border-emerald-300 transition-all cursor-pointer text-emerald-600 shadow-sm shadow-emerald-500/5"
      >
  ...
  if (filedStatus === 'Not Filed') {
    return (
      <button
        ...
        className="inline-flex items-center justify-center w-7 h-7 rounded-xl border border-slate-350 bg-slate-100 hover:bg-slate-200 hover:border-slate-400 transition-all cursor-pointer text-slate-500 shadow-sm"
      >
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center w-7 h-7 rounded-xl border border-dashed border-slate-300 bg-transparent hover:border-slate-400 hover:bg-slate-50 transition-all cursor-pointer text-slate-300 hover:text-slate-500"
    >
