                ...
                <div className="flex-1 flex flex-col bg-white rounded-[2.5rem] shadow-2xl border border-slate-300 overflow-hidden animate-in slide-in-from-bottom-6 duration-300">
                    ...
                    <div className="flex-1 overflow-y-auto p-10 space-y-12 custom-scrollbar pb-32">
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                <FormRow label="GSTIN Number"><input type="text" className="w-full h-[48px] bg-white border border-slate-300 rounded-2xl px-5 text-sm font-black font-mono uppercase" placeholder="GST NUMBER" value={client.gstin || ''} onChange={e => setClient({...client, gstin: e.target.value.toUpperCase()})} /></FormRow>
                                <FormRow label="PAN Number"><input type="text" className="w-full h-[48px] bg-white border border-slate-300 rounded-2xl px-5 text-sm font-black font-mono uppercase" placeholder="PAN NUMBER" value={client.panNo || ''} onChange={e => setClient({...client, panNo: e.target.value.toUpperCase()})} /></FormRow>
                                <FormRow label="DL Number"><input type="text" className="w-full h-[48px] bg-white border border-slate-300 rounded-2xl px-5 text-sm font-black font-mono uppercase" placeholder="DRUG LICENSE" value={client.dlNo || ''} onChange={e => setClient({...client, dlNo: e.target.value.toUpperCase()})} /></FormRow>
                                <FormRow label="UDYAM Number"><input type="text" className="w-full h-[48px] bg-white border border-slate-300 rounded-2xl px-5 text-sm font-black font-mono uppercase" placeholder="UDYAM ID" value={client.udyamNo || ''} onChange={e => setClient({...client, udyamNo: e.target.value.toUpperCase()})} /></FormRow>
                                <FormRow label="CIN Number"><input type="text" className="w-full h-[48px] bg-white border border-slate-300 rounded-2xl px-5 text-sm font-black font-mono uppercase" placeholder="CIN NUMBER" value={client.cinNo || ''} onChange={e => setClient({...client, cinNo: e.target.value.toUpperCase()})} /></FormRow>
