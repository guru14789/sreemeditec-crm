                ...
                const getParts = (ref: string) => {
                    ...
                    parts.forEach(p => {
                        if (p.startsWith('R') && p.length > 1) {
                            ...
                            const n = parseInt(p);
                            // Avoid capturing the year (e.g., 25-26)
                            if (!isNaN(n) && !p.includes('-') && p.length < 5) {
                                quoteNum = n;
                            }
                        }
                    });
                    return { quoteNum, revNum };
                };
